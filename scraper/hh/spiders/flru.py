...
class FlruSpider(scrapy.Spider):
    ...
    def spider_closed(self):
        if os.name == "posix":
            f = open('/home/ksn38/fl' + today + '.txt', 'w', encoding='utf-8')
        elif os.name == "nt":
            f = open('C:\\Users\\ksn\\hh\\fl\\source\\fl' + today + '.txt', 'w', encoding='utf-8')
        ...
        if os.name == "posix":
            tags_df.sort_values('val', ascending=False).to_csv('/home/ksn38/fl' + today + '.csv', index=False, encoding='utf-8')
        elif os.name == "nt":
            tags_df.sort_values('val', ascending=False).to_csv('C:\\Users\\ksn\\hh\\fl\\keywords\\fl' + today + '.csv', index=False, encoding='utf-8')
