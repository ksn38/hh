...
class FlcomSpider(scrapy.Spider):
    ...
    def spider_closed(self):
        ...
        if os.name == "posix":
            tags_df.sort_values('val', ascending=False).to_csv('/home/ksn38/flcom' + today + '.csv', index=False, encoding='utf-8')
        elif os.name == "nt":
            tags_df.sort_values('val', ascending=False).to_csv('C:\\Users\\ksn\\hh\\freelancer\\tags\\flcom' + today + '.csv', index=False,
                                                            encoding='utf-8')
